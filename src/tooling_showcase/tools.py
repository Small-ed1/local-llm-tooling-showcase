...
TOOL_SURFACE_TAGS = {
    "abort_task": ("manual-only", "stateful", "experimental"),
    "adapter_inventory": ("planner-safe",),
    "analyze_image": ("manual-only", "experimental"),
    "append_file": ("manual-only", "mutation", "experimental"),
    "apply_patch": ("manual-only", "mutation", "experimental"),
    "build_index": ("planner-safe", "stateful"),
    "build_project": ("manual-only", "mutation", "shell", "experimental"),
    "calculate": ("manual-only", "experimental"),
    "check_permission": ("manual-only", "experimental"),
    "content_search": ("planner-safe",),
    "control_device": ("manual-only", "stateful", "experimental"),
    "convert_units": ("manual-only", "experimental"),
    "copy_file": ("manual-only", "mutation", "experimental"),
    "create_file": ("manual-only", "mutation", "experimental"),
    "create_memory": ("planner-safe", "stateful"),
    "datetime_now": ("manual-only", "experimental"),
    "delete_file": ("manual-only", "mutation", "experimental"),
    "delete_from_index": ("manual-only", "mutation", "stateful", "experimental"),
    "delete_memory": ("planner-safe", "stateful"),
    "draft_system_prompt": ("planner-safe",),
    "download_file": ("manual-only", "mutation", "network", "experimental"),
    "edit_memory": ("planner-safe", "stateful"),
    "encode_decode": ("manual-only", "experimental"),
    "env_vars": ("manual-only", "experimental"),
    "execute_script": ("manual-only", "mutation", "shell", "experimental"),
    "execute_step": ("manual-only", "stateful", "experimental"),
    "expand_search_result": ("planner-safe", "network"),
    "expand_search_results": ("manual-only", "network", "experimental"),
    "extract_webpage_content": ("manual-only", "network", "experimental"),
    "fetch_url": ("manual-only", "network", "experimental"),
    "file_search": ("planner-safe",),
    "find_symbol": ("manual-only", "experimental"),
    "format_code": ("manual-only", "mutation", "shell", "experimental"),
    "generate_uuid": ("manual-only", "experimental"),
    "get_file_info": ("manual-only", "experimental"),
    "get_task_status": ("manual-only", "stateful", "experimental"),
    "git_add": ("manual-only", "mutation", "experimental"),
    "git_branch": ("manual-only", "mutation", "experimental"),
    "git_checkout": ("manual-only", "mutation", "experimental"),
    "git_commit": ("manual-only", "mutation", "experimental"),
    "git_diff": ("manual-only", "experimental"),
    "git_log": ("manual-only", "experimental"),
    "git_merge": ("manual-only", "mutation", "experimental"),
    "git_reset": ("manual-only", "mutation", "experimental"),
    "git_stash": ("manual-only", "mutation", "experimental"),
    "git_status": ("manual-only", "experimental"),
    "grep_search": ("manual-only", "experimental"),
    "hash_file": ("manual-only", "experimental"),
    "install_dependencies": ("manual-only", "mutation", "shell", "experimental"),
    "kill_process": ("manual-only", "mutation", "shell", "experimental"),
    "latest_linux_kernel": ("manual-only", "network", "experimental"),
    "library_info": ("planner-safe",),
    "library_read_epub": ("planner-safe",),
    "library_read_zim": ("planner-safe",),
    "library_search": ("planner-safe",),
    "lint_code": ("manual-only", "mutation", "shell", "experimental"),
    "list_directory": ("manual-only", "experimental"),
    "list_indexed_sources": ("manual-only", "stateful", "experimental"),
    "list_memories": ("planner-safe", "stateful"),
    "load_checkpoint": ("manual-only", "stateful", "experimental"),
    "load_memory": ("planner-safe", "stateful"),
    "local_doc_paths": ("manual-only", "experimental"),
    "local_doc_read": ("planner-safe",),
    "local_doc_replace": ("manual-only", "mutation", "experimental"),
    "local_doc_search": ("planner-safe",),
    "log_event": ("manual-only", "stateful", "experimental"),
    "log_sensitive_action": ("manual-only", "stateful", "experimental"),
    "mark_step_complete": ("manual-only", "stateful", "experimental"),
    "mark_step_failed": ("manual-only", "stateful", "experimental"),
    "move_file": ("manual-only", "mutation", "experimental"),
    "parse_json_api": ("manual-only", "network", "experimental"),
    "parse_pdf": ("manual-only", "experimental"),
    "plan_task": ("manual-only", "stateful", "experimental"),
    "process_list": ("manual-only", "shell", "experimental"),
    "query_index": ("planner-safe", "stateful"),
    "record_error": ("manual-only", "stateful", "experimental"),
    "record_tool_latency": ("manual-only", "stateful", "experimental"),
    "read_file": ("planner-safe",),
    "replay_session": ("manual-only", "stateful", "experimental"),
    "request_user_approval": ("manual-only", "experimental"),
    "retry_step": ("manual-only", "stateful", "experimental"),
    "run_model": ("manual-only", "experimental"),
    "run_tests": ("manual-only", "mutation", "shell", "experimental"),
    "safe_shell_command": ("manual-only", "mutation", "shell", "experimental"),
    "sandbox_file_access": ("manual-only", "experimental"),
    "sandbox_shell_execution": ("manual-only", "mutation", "shell", "experimental"),
    "save_memory": ("planner-safe", "stateful"),
    "screenshot_page": ("manual-only", "network", "experimental"),
    "shell_command": ("shell",),
    "summarize_run": ("manual-only", "stateful", "experimental"),
    "summarize_session": ("manual-only", "stateful", "experimental"),
    "system_info": ("manual-only", "experimental"),
    "task_checkpoint": ("manual-only", "stateful", "experimental"),
    "text_to_speech": ("manual-only", "experimental"),
    "tool_structure": ("planner-safe",),
    "trace_step": ("manual-only", "stateful", "experimental"),
    "transcribe_audio": ("manual-only", "experimental"),
    "tree_view": ("planner-safe",),
    "update_index": ("manual-only", "stateful", "experimental"),
    "update_memory": ("planner-safe", "stateful"),
    "web_search": ("planner-safe", "network"),
    "weather_lookup": ("manual-only", "network", "experimental"),
    "write_file": ("manual-only", "mutation", "experimental"),
}
...
class ToolRuntime:
    ...
    def tool_structure(self) -> ToolCall:
        ...
        for tool in available:
            ...
            tags = tuple(TOOL_SURFACE_TAGS.get(tool, ("manual-only", "experimental")))
            tools.append(
                {
                    "id": tool,
        ...
        data = {
            ...
            "classification": {
                tag: sorted(name for name in available if tag in TOOL_SURFACE_TAGS.get(name, ()))
                for tag in ("planner-safe", "manual-only", "mutation", "shell", "network", "stateful", "experimental")
            },
            "manual_confirmation": sorted(name for name in available if name in MANUAL_CONFIRMATION_TOOLS),
        }
