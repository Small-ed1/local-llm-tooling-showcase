...
def _split_thinking_text(message: str) -> tuple[str, str]:
    text = message or ""
    for start_marker, end_marker in (("<think>", "</think>"), ("<thinking>", "</thinking>"), ("Thinking...", "...done thinking.")):
...
class ShowcaseService:
    ...
    def _split_stream_thinking(self, result: ActionResult) -> tuple[str, str]:
        ...
        split_thinking, clean_msg = _split_thinking_text(result.message)
